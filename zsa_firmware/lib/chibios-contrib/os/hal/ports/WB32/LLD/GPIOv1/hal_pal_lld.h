 ...
 * @{
 */
#define PAL_WB32_MODE_MASK                     (3U << 0U)
#define PAL_WB32_MODE_INPUT                    (0U << 0U)
#define PAL_WB32_MODE_OUTPUT                   (1U << 0U)
#define PAL_WB32_MODE_ALTERNATE                (2U << 0U)
#define PAL_WB32_MODE_ANALOG                   (3U << 0U)

#define PAL_WB32_OTYPE_MASK                    (1U << 2U)
...
#define PAL_WB32_PUPDR_MASK                    (3U << 5U)
#define PAL_WB32_PUPDR_FLOATING                (0U << 5U)
#define PAL_WB32_PUPDR_PULLUP                  (1U << 5U)
#define PAL_WB32_PUPDR_PULLDOWN                (2U << 5U)
 ...
 */
#define PAL_MODE_ALTERNATE(n)                  (PAL_WB32_MODE_ALTERNATE |   \
                                                PAL_WB32_ALTERNATE(n))
/** @} */
 ...
 */
#define PAL_MODE_RESET                         PAL_WB32_MODE_INPUT
 ...
 */
#define PAL_MODE_INPUT                         PAL_WB32_MODE_INPUT

/**
 * @brief   Input pad with weak pull up resistor.
 */
#define PAL_MODE_INPUT_PULLUP                  (PAL_WB32_MODE_INPUT |       \
                                                PAL_WB32_PUPDR_PULLUP)

/**
 * @brief   Input pad with weak pull down resistor.
 */
#define PAL_MODE_INPUT_PULLDOWN                (PAL_WB32_MODE_INPUT |       \
                                                PAL_WB32_PUPDR_PULLDOWN)

/**
 * @brief   Analog input mode.
 */
#define PAL_MODE_INPUT_ANALOG                  PAL_WB32_MODE_ANALOG

/**
 * @brief   Push-pull output pad.
 */
#define PAL_MODE_OUTPUT_PUSHPULL               (PAL_WB32_MODE_OUTPUT |      \
                                                PAL_WB32_OTYPE_PUSHPULL)

/**
 * @brief   Open-drain output pad.
 */
#define PAL_MODE_OUTPUT_OPENDRAIN              (PAL_WB32_MODE_OUTPUT |      \
                                                PAL_WB32_OTYPE_OPENDRAIN)
/** @} */
