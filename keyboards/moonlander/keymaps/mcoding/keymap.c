...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_LCTRL,       KC_LALT,        KC_LALT,        KC_LALT,        KC_LGUI,        KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_LBRACKET,    KC_RBRACKET,    KC_RALT,        KC_RCTRL,       MO(1),
    ...
    [1] = LAYOUT_moonlander(
        ...
        WEBUSB_PAIR,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RGB_VAD,                                                                                                        RGB_VAI,        RSFT(KC_LBRACKET),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT,
