...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_LCTRL,       KC_LALT,        KC_LALT,        KC_LALT,        KC_LGUI,        KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_LBRACKET,    KC_RBRACKET,    KC_RALT,        KC_RALT,        MO(1),
        KC_SPACE,       KC_BSPACE,      KC_LALT,                        KC_SPACE,       KC_BSPACE,      KC_ENTER
    ),
    ...
    [1] = LAYOUT_moonlander(
        ...
        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RGB_VAD,                                                                                                        RGB_VAI,        RSFT(KC_LBRACKET),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT,
    ...
    [2] = LAYOUT_moonlander(
        ...
        KC_CAPSLOCK,    KC_MEDIA_PLAY_PAUSE,KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,                                                                KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
